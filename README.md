...
* **Professional Footer:** Contains academic info and Laboratory Work details.
...
3. The top navigation bar allows switching between **Contacts**, **Profile**, and **About**.
4. Detailed academic and Laboratory info is accessible via the **Footer** or **About** page links.
